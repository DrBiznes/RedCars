            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                    ...
                    <div className="flex justify-between items-end mb-4">
                        ...
                        <div className="text-right">
                            ...
                            <p className="text-xl font-['Josefin_Sans'] font-bold text-foreground">
                                {routeResult.segments.reduce((acc: any, seg: any) => acc + seg.distance, 0).toFixed(1)}<span className="text-sm ml-1 text-muted-foreground">mi</span>
                            </p>
                        </div>
                    </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="relative pl-6 space-y-6 before:absolute before:left-[7px] before:top-2 before:bottom-2 before:w-[2px] before:bg-border/50">
                        {consolidateSegments(routeResult.segments).map((seg: any, idx: number) => (
